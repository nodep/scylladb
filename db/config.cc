...
db::config::config(std::shared_ptr<db::extensions> exts)
    ...
    */
    ...
    , effective_capacity_smoothing_threshold(this, "effective_capacity_smoothing_threshold", liveness::LiveUpdate, value_status::Used, 0.001,
        ...
        "value by more than this fraction (e.g. 0.001 = 0.1%). This prevents load balancer oscillations "
